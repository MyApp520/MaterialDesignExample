...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener {
    ...
    private boolean isMustSelectOne = true;//true表示：必须至少选择一个flowtab
    ...
    public TagFlowLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        isMustSelectOne = ta.getBoolean(R.styleable.TagFlowLayout_is_must_select_one, true);
        ta.recycle();
    }
            ...
            tagViewContainer.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mSelectedMax == 1 && mSelectedView.size() == 1) {
                        ...
                        Log.e(TAG, "点击了流式布局 preIndex = " + preIndex + ", position = " + position + ", isMustSelectOne = " + isMustSelectOne);
                        if (isMustSelectOne && position == preIndex) {
                            // 点击的是同一个，不能再点击了
                            return;
                        }
                    }
                    Log.e(TAG, "点击了流式布局 准备执行doSelect()");
    ...
    public boolean isMustSelectOne() {
        return isMustSelectOne;
    }

    public void setMustSelectOne(boolean mustSelectOne) {
        isMustSelectOne = mustSelectOne;
    }
