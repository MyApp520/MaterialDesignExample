package com.smile.commonlib.mpandroidchart.renderer;
...
public class SecondPieChartRendererFixCover extends PieChartRenderer {
    private final String TAG = SecondPieChartRendererFixCover.class.getSimpleName();
    private int measuredHeight;
    private float topAndBottomSpace;

    public SecondPieChartRendererFixCover(PieChart chart, ChartAnimator animator, ViewPortHandler viewPortHandler) {
